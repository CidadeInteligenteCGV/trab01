...
CREATE VIEW alunos_matriculados AS SELECT nome_aluno AS Alunos, cod_matricula AS Matriculas FROM aluno;

CREATE VIEW disciplinas_curso AS SELECT a.nome_disciplina AS disciplina, c.nome_curso AS curso FROM disciplina a, curso c WHERE a.fk_curso_cod_curso = c.cod_curso;
...
CREATE VIEW imei_smartphone_aluno AS SELECT nome_aluno AS aluno, cod_matricula AS matricula, imei FROM aluno;

CREATE VIEW curso_do_campus AS SELECT a.nome_curso AS curso, c.campus AS campus
FROM curso a, campi c WHERE a.fk_campus_cod_campus = c.cod_campus;
